...
enum CreatureFlagsExtra : uint32
{
    ...
    CREATURE_FLAG_EXTRA_UNUSED_26            = 0x04000000,       // custom flag for NPCBots (not confirmed safe)
    CREATURE_FLAG_EXTRA_UNUSED_27            = 0x08000000,       // custom flag for NPCBot pets (not confirmed safe)
